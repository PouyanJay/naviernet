...
const DATA: InterfaceData = {
  ...
  frames: [
    { t_ms: 0, contours: [[[100, 100], [300, 100], [300, 250], [100, 250]]] },
    { t_ms: 2.5, contours: [[[100, 100], [700, 100], [700, 250], [100, 250]]] },
  ],
  measured: [{ t_ms: 0, contours: [[[110, 110], [290, 110], [290, 240]]] }],
};
...
describe("ReconstructionViewport", () => {
  ...
  it("toggles layers off and scrubs to a later instant", () => {
    ...
    fireEvent.change(screen.getByRole("slider", { name: "Scrub reconstruction time" }), {
      target: { value: "1" },
    });
